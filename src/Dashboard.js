...
class Dashboard extends Component {
  constructor() {
    ...
    this.gitdelApi = this.gitdelApi.bind(this);
  }
  ...
  downloadBody = rowData => {
    if (rowData.type === "file") {
      return (
        <Button
          icon="pi pi-download"
          onClick={() => window.open(rowData.download_url, "_blank")}
        />
      );
  ...
  uploadGithub = async () => {
    ...
    var apiurl;
    if (this.state.uploadFolderName !== "") {
      apiurl =
        "https://api.github.com/repos/" +
        nameWithOwner +
        "/contents/" +
        this.state.uploadFolderName +
        "/" +
        fileName;
    } else
      apiurl =
      ...
      <div>
        ...
        <div className="ui-grid">
          ...
          <div className="ui-grid">
            <InputText
              ...
              style={{ width: "70%" }}
              onChange={e => this.setState({ mainUrl: e.target.value })}
          ...
          <div className="ui-grid">
            ...
            />
            <InputText
              value={this.state.gitUserRepo}
              onChange={e => this.setState({ gitUserRepo: e.target.value })}
              placeholder="Repo"
            />
            <InputText
              value={this.state.gitUserPath}
              onChange={e => this.setState({ gitUserPath: e.target.value })}
              placeholder="Path"
            />
            <Dropdown
              value={this.state.branchesValue}
              options={branchesOption}
              onChange={e => {
                this.setState({ branchesValue: e.value });
              }}
            ...
            <div>
              ...
              >
                ...
                <Column
                  ...
                  filter={true}
                />
                <Column body={this.dirBody} header="Dir/File" />
                <Column body={this.downloadBody} header="Download" />
                <Column body={this.deleteBody} header="Delete" />
              </DataTable>
            </div>
          </div>
        ) : (
        ...
        <div className="ui-grid">
          ...
          <InputText
            ...
            onChange={e => this.setState({ commitMsg: e.target.value })}
            placeholder="User "
          />
          &nbsp;
          <InputText
            value={this.state.uploadfilePath}
            onChange={e => this.setState({ uploadfilePath: e.target.value })}
            placeholder="User "
          />
          &nbsp;
          <InputText
            value={this.state.uploadfileName}
            onChange={e => this.setState({ uploadfileName: e.target.value })}
            placeholder="File Name "
          />
          &nbsp;
          <InputText
            value={this.state.uploadFolderName}
            onChange={e => this.setState({ uploadFolderName: e.target.value })}
            placeholder="Folder "
          />
          &nbsp;
